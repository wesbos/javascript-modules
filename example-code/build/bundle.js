...
var _objectExport = require('./object-export');

var _objectExport2 = _interopRequireDefault(_objectExport);
...
(0, _jquery2.default)('.click-me').on('click', (0, _lodash.throttle)(function () {
  console.count('ouch!');
}, 1000));

},{"./helpers":2,"./not-a-module":8,"./object-export":9,"jquery":4,"lodash":5,"superagent":7}],2:[function(require,module,exports){
'use strict';
...
var couponCodes = exports.couponCodes = ['BLACKFRIDAY', 'FREESHIP', 'HOHOHO'];
...
var coolDude = {
  ...
  last: 'bos',
  twitter: '@wesbos',
  github: 'http://github.com/wesbos'
};

exports.default = coolDude;
